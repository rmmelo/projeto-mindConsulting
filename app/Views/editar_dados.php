        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="\dashboard_comum">Perfil</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page href="\editarDados?id=<?php echo $usuario_session->get('ID') ?>">Editar dados</a>
              </li>
            </ul>
          </div>
            ...
            <div class="card w-50">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/atualizar_2" method="post">
