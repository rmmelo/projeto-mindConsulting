        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="\dashboard_admin">Admin</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="\editar_dados2?id=<?php echo $usuario_session->get('ID') ?>">Editar dados</a>
              </li>
            </ul>
          </div>
                ...
                <div class="w-100">
                    <div class="card mx-auto">
                        <div class="card-body text-center">
                            ...
                            <a href="/editar_dados2?id=<?php echo $usuario_session->get('ID') ?>" class="btn btn-danger">Editar dados</a>                   
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body text-center">
                            <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th scope="row"><?php echo $usuario['NomeCompleto']?></th>
                                    <td><?php echo $usuario['CPF']?></td>
                                    <td><?php echo $usuario['Email']?></td>
                                    <td><a href="/editar_dados2?id=<?php echo $usuario['ID']?>" class="btn btn-danger">Alterar Dados</a></td>
                                  </tr>
                                  <?php } ?>
                                </tbody>
                              </table>                   
